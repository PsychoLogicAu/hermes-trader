...
const SECTIONS = [
  ...
  { label: 'safety',        keys: ['daily_kill_pct_of_equity','daily_kill_cap_usd','daily_kill_flatten_mult','daily_kill_min_usd','daily_loss_halt','stop_loss_cooldown_min','cooldown_min','min_ai_confidence','counter_regime_min_conf','max_crypto_long_correlated'] },

    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "daily_kill_pct_of_equity": {"type": "number", "description": "Daily-loss kill T as a fraction of equity: blocks new entries + arms the halt timer at −T (0=off)."},
                "daily_kill_cap_usd": {"type": "number", "description": "Absolute ceiling on the daily-loss kill threshold in USD (0=off)."},
                "daily_kill_flatten_mult": {"type": "number", "description": "Hard flatten fires at this multiple of the kill threshold (default 1.25; 1.0 = flatten at the same level as the halt)."},
...
def handle_config(params: Dict[str, Any]) -> str:
    ...
    _DIRECT_KEYS = [
        ...
        "min_available_margin_pct", "daily_kill_pct_of_equity", "daily_kill_cap_usd",
        "daily_kill_flatten_mult",

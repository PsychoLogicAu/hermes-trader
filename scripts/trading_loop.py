    ...
    try:
        ...
        if action == "execute":
            ...
            log_event({"event": "execute", "coin": coin,
                       ...
                       "ai_down": result.get("ai_down"),
                       "composite_score": result.get("composite_score"),
                       "volume_spike_fired": result.get("volume_spike_fired"),
                       "breakout_fired": result.get("breakout_fired"),
                       "momentum_burst_fired": result.get("momentum_burst_fired"),
                       "daily_mover_fired": result.get("daily_mover_fired"),
                       "slow_burn_count": result.get("slow_burn_count"),
                       "whale_fired": result.get("whale_fired"),
            ...
            log_event({"event": "pass", "coin": coin,
                       ...
                       "llm_confidence": routed.get("llm_confidence"),
                       "llm_model": routed.get("llm_model"),
                       "ai_down": routed.get("ai_down"),
                       "composite_score": routed.get("composite_score"),
                       "volume_spike_fired": routed.get("volume_spike_fired"),
                       "breakout_fired": routed.get("breakout_fired"),
                       "momentum_burst_fired": routed.get("momentum_burst_fired"),
                       "daily_mover_fired": routed.get("daily_mover_fired"),
                       "slow_burn_count": routed.get("slow_burn_count"),
                       "whale_fired": routed.get("whale_fired"),
